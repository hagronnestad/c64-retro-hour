...
unsigned int episodes_count = 339;
char* episodes_update_date = "2022-08-13";
char* episodes[] = {
    "Allister Brimble",
    ...
    "Developing Doom with iD Software legend Dave Taylor",
    "Making New Apple II RPGs Nox Archaist",
    "Sierra Adventures and Tsunami Media FMV Games with Ken Allen",
    "Reinventing The Amiga Games Scene with Earok",
    "Beneath a Steel Sky & Revolution Software with Tony Warriner",
    "The Voice of Duke Nukem Jon St John",
    "Die Hard Vendetta with Steve Goodwin",
    "The Simpson's Hit & Run The Making of with John Melchior",
    "Road Rash creator Randy Breen",
    "Final Vendetta - Making New Retro Beat 'Em Ups",
    "Retro Apple Prototypes with Krazy Ken/Computer Clan",
    "The Commodore Amiga 500 Story",
    "Rare's Road To The Game Boy with Paul Machacek",
    "Composing Tomb Raider with Peter Connelly",
    "The Golden Age of Atari with Ed Rotberg",
    "Shadow of The Beast & Driver with Martin Edmonson",
    "Missile Command and Gravitar with Rich Adam",
};
